...
public class SFStudent extends javax.swing.JFrame {
    ...
    public SFStudent() {
        ...
        this.list.add(new Student("29211143696", "Le Nhat Anh", "Cong nghe phan mem"));
        View();
    ...
    public void View() {
        ...
        this.txtMajor.setText(x.getMajor());
        OnOff(true, false);
    }
    ...
    public void ViewTable(String name) {
        ...
        for (Student x : list) {
            if (x.getName().contains(name)) {
                model.addRow(new Object[]{n++, x.getID(), x.getName(), x.getMajor()});
            }
        }
    ...
    private void initComponents() {
        ...
        txtMajor.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtSearchName, javax.swing.GroupLayout.PREFERRED_SIZE, 287, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String major = this.txtMajor.getText();
        if (check == 1) {
            this.list.add(new Student(ID, name, major));
        } else {
            this.list.set(pos, new Student(ID, name, major));
        }
        View();
        ViewTable(this.txtSearchName.getText());
